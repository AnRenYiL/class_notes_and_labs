...
# Require in Ruby does what include does in most other languages:
# run another file. It also tracks what you've required in the past
# and won't require the same file twice.

# To inherit from a class, use `<` when declaring the class
# as shown below.

# By default, all classes will inherit from the Object class, unless
# another superclass is provided.
class Oreo < Cookie
